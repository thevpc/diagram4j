 ...
 * @author vpc
 */
public class JDiagramAddSegmentAction extends AbstractDiagramEditorAction {
    ...
    public SegmentShape getShape() {
        if (point1 != null && point2 != null) {
            ...
            if (radius > 0) {
                SegmentShape c = new SegmentShape(point1.x, point1.y, point2.x, point2.y);
