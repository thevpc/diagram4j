...
public class DiagramArrows {
    ...
    //https://gist.github.com/raydac/df97493f58b0521fb20a//https://gist.github.com/raydac/df97493f58b0521fb20a

    public static DiagramArrowType parseArrowTypeLenient(String s) {
        if (s == null || s.trim().isEmpty()) {
            return DiagramArrowType.NONE;
        }
        try {
            return DiagramArrowType.valueOf(s.toUpperCase());
        } catch (Exception ex) {
            return DiagramArrowType.NONE;
        }
    }
    ...
    public static void drawArrow(final Graphics2D gfx, final Point2D start, final Point2D end, final Stroke lineStroke,
            ...
            DiagramArrowType startArrowType,
            DiagramArrowType endArrowType
    ) {
        if (startArrowType == null) {
            startArrowType = DiagramArrowType.NONE;
        }
        if (endArrowType == null) {
            endArrowType = DiagramArrowType.NONE;
        }
